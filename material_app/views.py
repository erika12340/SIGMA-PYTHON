    ...
    if sfc_code and mat_info and start_date and end_date and trc_fl_phase:
        ...
        def shift_time_range(shift):
            if shift == 1:
                ...
                return time(0, 0, 0), time(23, 59, 59)  # fallback
        ...
        if start_shift:
            start_time, end_time = shift_time_range(start_shift)
        ...
        for item in traceability_raw:
            ...
            if item['TRC_FL_PHASE'] == baris1_phase:
                ...
                # 🔥 Tambahkan child rekursif
                traceability_materials += get_child_cu_tree(
                    item['TRC_SO_CODE'], item['TRC_CU_EXT_PROGR'], level=1
                )
